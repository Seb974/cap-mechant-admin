...
const ProductPage = ({ match, history }) => {
    ...
    const [product, setProduct] = useState({name: "", weight:"", userGroups: [], image: null, unit: "Kg", productGroup: "J + 1", fullDescription: "", stock: defaultStock, stockManaged: true, tax: "-1", uniquePrice: true, prices: [], available: true, requireLegalAge: false, new: true, isMixed: false, categories: []});        // [{name: 'BASE', price:""}, {name: 'USER_VIP', price:""}, {name: 'PRO_CHR', price:""}, {name: 'PRO_GC', price:""}, {name: 'PRO_VIP', price:""}]
